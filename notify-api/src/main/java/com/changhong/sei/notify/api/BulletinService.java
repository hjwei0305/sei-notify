...
public interface BulletinService extends FindByPageService<BulletinDto> {
    ...
    @ApiOperation(value = "保存通告", tags = "维护一个消息通告")
    ...
    @ApiOperation(value = "发布通告", tags = "批量发布通告")
    ...
    @ApiOperation(value = "撤销通告", tags = "批量撤销通告")
    ...
    @ApiOperation(value = "删除通告", tags = "批量删除通告")
    ...
    @ApiOperation(value = "查看通告", tags = "获取一个通告")
